...
export default {
  ...
  setup() {
    ...
    async function addOdItem(responseModel: NotifierResponseEvent) {
      ...
      const item: NotificationViewModel = setUpTimes(odm, 0);
    ...
    async function addFrItem(responseModel: NotifierResponseEvent) {
      ...
      const item: NotificationViewModel = setUpTimes(frm, 1);
    ...
    async function addLprItem(responseModel: NotifierResponseEvent) {
      ...
      const item: NotificationViewModel = setUpTimes(alrp, 2);
    ...
    return {
      ...
      onPopupShow,
      onOpenImageNewWindow(item: NotificationViewModel) {
