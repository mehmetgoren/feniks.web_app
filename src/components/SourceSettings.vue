    ...
    <q-stepper v-model='step' vertical color='cyan' animated>
      ...
      <q-step :name='3' title='Input' icon='input' color='cyan' disable>
        <q-form class='q-gutter-md'>
          ...
          <q-input :dense='dense' filled v-model.number='source.probe_size' type='number' label='Probe Size' color='cyan' />
      ...
      <q-step v-if='source.recording' :name='6' title='Recording' icon='radio_button_checked' color='cyan'
        ...
        <q-form class='q-gutter-md'>
          ...
          <q-input v-if='showRecordingDetail' :dense='dense' filled v-model.number='source.record_width' type='number'
                   label='Record Width' color='cyan' />
          <q-input v-if='showRecordingDetail' :dense='dense' filled v-model.number='source.record_height' type='number'
