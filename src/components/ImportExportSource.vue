...
export default {
  ...
  setup() {
    ...
    return {
      showImportList, sources, selectedSources, sourceFilter,
      sourceDatabind, onExport, onImport,
      sourceColumns: createSourceColumns(t)
    }
  }
}

function createSourceColumns(t: any) {
  const align = 'left';
  return [
