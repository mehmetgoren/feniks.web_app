...
import {useQuasar, exportFile, Screen} from 'quasar';
...
const filterClassTemplate = {'col-xs-12': true, 'col-sm-6': true, 'col-md-6': true, 'col-lg-3': true, 'col-xl-3': true};
const filterFullRowClassTemplate = {'col-xs-12': true, 'col-sm-12': true, 'col-md-12': true, 'col-lg-12': true, 'col-xl-12': true};
const filterClass = ref<any>(filterClassTemplate);
...
function setFilterElementWidth() {
  const w = window.innerWidth;
  if (w > 700 && w < 1650){
    filterClass.value = {...filterClassTemplate, 'col-lg-3': false, 'col-xl-3': false};
  } else if (w > 600 && w < 700){
    filterClass.value = {...filterFullRowClassTemplate};
  } else {
    filterClass.value = {...filterClassTemplate};
  }
}
